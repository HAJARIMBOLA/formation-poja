package com.formation.hei.endpoint.event.model;

import static com.formation.hei.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.formation.hei.PojaGenerated;
import com.formation.hei.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "com.formation.hei.event1";
    return "com.formation.hei.event2";
  }
}
