package com.formation.hei.endpoint.event.consumer;

import com.formation.hei.PojaGenerated;
import com.formation.hei.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.formation.hei.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.formation.hei.service.event."
