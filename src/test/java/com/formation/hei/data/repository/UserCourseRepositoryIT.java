...
class UserCourseRepositoryIT extends FacadeIT {
    ...
    void enregistre_et_relie_un_utilisateur_a_plusieurs_cours() {
        ...
        assertThat(savedJava.getUsers()).extracting(User::getUserName).containsExactlyInAnyOrder(
                "jdupont", "mrakoto");

        // A user can be enrolled in several courses.
        assertThat(savedUser.getCourses()).extracting(Course::getTitle).containsExactlyInAnyOrder(
